...
class ChartSlideBuilder:
    ...
    def _copy_background(self, target_slide):
        for shape in self.bg_slide.shapes:
            if shape.has_text_frame:
                ...
                with open("temp_img.png", "wb") as f:
                    f.write(image.blob)
                target_slide.shapes.add_picture("temp_img.png", shape.left, shape.top, shape.width, shape.height)
    ...
    def add_custom_text_slide(self, slide, text, x=1, y=2, width=8, height=2, font_size=32,font_name='Vazir'):
